import '../splash_two_screen/widgets/listanganwadiiconone1_item_widget.dart';
import '../splash_two_screen/widgets/listlabel1_item_widget.dart';
import 'controller/splash_two_controller.dart';
import 'models/listanganwadiiconone1_item_model.dart';
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Obx(() => ListView.builder(
                              ...
                              shrinkWrap: true,
                              itemCount: controller.splashTwoModelObj.value
                                  .listanganwadiiconone1ItemList.length,
                              itemBuilder: (context, index) {
                                Listanganwadiiconone1ItemModel model =
                                    controller.splashTwoModelObj.value
                                        .listanganwadiiconone1ItemList[index];
                                return Listanganwadiiconone1ItemWidget(model);
                              })))
                    ]))));
  }
